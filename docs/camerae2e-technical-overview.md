...
| RAW data factory | `camerae2e_dataset_export(...)`, `camerae2e_dataset_export_from_optimization(...)`, `camerae2e_dataset_validate(...)` | perception 학습용 deterministic RAW NPZ, optimization best/top/Pareto case export, split, checksum, RGB preview, labels JSON, metadata JSONL, manifest export/validation |
