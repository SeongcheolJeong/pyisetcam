...
- with the broad-parity expansion now started by adding post-core scene-family cases, utility-helper cases, and initial metrics-family cases for `ieXYZFromEnergy` and `xyz2luv`
