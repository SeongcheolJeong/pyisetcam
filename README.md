...
- and now also corrected the shared `sceneCreate('line ...', ...)` mean-luminance normalization plus curated Octave parity on `sceneCreate('line ee', ...)`, covering the equal-energy vertical-line geometry with offset and the same `100 cd/m^2` luminance contract
